            ...
            while (true)
            {
                ...
                switch (choice)
                {
                    ...
                    case 3:
                        ...
                        if (!validationCheck.IsProjectIdValid(projectIdForAddEmployee))
                        {
                        ...
                        for (int i = 0; i < employeeAddToProject; i++)
                        {
                            ...
                            if (!validationCheck.IsEmployeeIdValid(employeeIdForAddToProject))
                            {
                                Console.WriteLine("Employee Is not Found");
                                break;
                            }
                            if (validationCheck.EmployeeIsAlreadyPresentInProject(employeeIdForAddToProject))
                            {
                    ...
                    case 4:
                        ...
                        if (!validationCheck.IsProjectIdValid(projectIdforFind))
                        {
                            Console.WriteLine("Project Id Is Not Found.....");
                            break;
                        }
                        ...
                        Console.WriteLine("***************************************************************************************************************************************************");
                        Console.WriteLine($"Project Name: {projectDetails.ProjectName}   |   Project Start Date: {projectDetails.ProjectStartDate} Project End Date: {projectDetails.ProjectEndDate}");
                        Console.WriteLine();
                        ...
                        foreach (var employees in projectDetails.ProjectEmployees!)
                        {
                            ...
                            var roles = RoleRepo.roleList.SingleOrDefault(e => e.RoleId == employees.EmployeeRoleId);
                    ...
                    case 5:
                        ...
                        if (!validationCheck.IsProjectIdValid(projectIdForRemoveEmployee))
                        {
                            Console.WriteLine("Project Id Is Not Found.....");
                            break;
                        }
                        ...
                        if (!validationCheck.IsEmployeeIdValid(employeeIdForRemoveFormProject))
                        {
                            Console.WriteLine("Employee Is not Found");
                            break;
                        }
                        if (!validationCheck.EmployeeIsAlreadyPresentInProject(employeeIdForRemoveFormProject))
                        {
                    ...
                    case 6:
                        ...
                        if (!validationCheck.IsProjectIdValid(projectIdforDelete))
                        {
                            Console.WriteLine("Project Id Is Not Found.....");
                            break;
                        }
