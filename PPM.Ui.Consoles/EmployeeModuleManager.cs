            ...
            while (true)
            {
                ...
                switch (choice)
                {
                    case 1:
                        ...
                        if (validationCheck.IsEmployeeIdValid(employeeId))
                        {
                    ...
                    case 3:
                        ...
                        if (!validationCheck.IsEmployeeIdValid(employeeIdforFind))
                        {
                    ...
                    case 4:
                        ...
                        if (!validationCheck.IsEmployeeIdValid(employeeIdforDelete))
                        {
                            Console.WriteLine("Employee Id is Not Present....");
                            break;
                        }
                        if (validationCheck.EmployeeIsAlreadyPresentInProject(employeeIdforDelete))
                        {
